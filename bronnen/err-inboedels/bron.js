...
function refreshMap(){
    ...
    $.ajax({
        type: 'GET',
        url: 'bronnen/err-inboedels/geojson.php',
        dataType: 'json',
        data: {
...
function showBron() {
    $('#main').load('bronnen/err-inboedels/over.php');
}
...
function whenClicked(){
    ...
    var props = $(this)[0].feature.properties;
    $("#main").load('bronnen/err-inboedels/adres.php?adressen=' + JSON.stringify(props['adressen']));
