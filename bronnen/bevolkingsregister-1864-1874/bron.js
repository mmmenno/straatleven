...
function refreshMap(){
    ...
    $.ajax({
        type: 'GET',
        url: 'bronnen/bevolkingsregister-1864-1874/geojson.php',
        dataType: 'json',
        data: {
        ...
        success: function(jsonData) {
            ...
            lps = L.geoJson(null, {
                pointToLayer: function (feature, latlng) { 
                    ...
                    var markertitle = feature.properties.cnt + ' geregistreerden in '
                    if(feature.properties.cnt == 1){
                        var markertitle = feature.properties.cnt + ' geregistreerde'
                    }
...
function showBron() {
    $('#main').load('bronnen/bevolkingsregister-1864-1874/over.php');
}
...
function whenClicked(){
    ...
    var props = $(this)[0].feature.properties;
    $("#main").load('bronnen/bevolkingsregister-1864-1874/adres.php?adressen=' + JSON.stringify(props['adressen']));
