...
function refreshMap(){
    ...
    $.ajax({
        type: 'GET',
        url: 'bronnen/woningkaarten/geojson.php',
        dataType: 'json',
        data: {
        ...
        success: function(jsonData) {
            ...
            lps = L.geoJson(null, {
                pointToLayer: function (feature, latlng) { 
                    ...
                    var markertitle = feature.properties.cnt + ' woningkaarten in'
                    if(feature.properties.cnt == 1){
                        var markertitle = feature.properties.cnt + ' woningkaart'
                    }
...
function showBron() {
    $('#main').load('bronnen/woningkaarten/over.php');
}
...
function whenClicked(){
    ...
    var props = $(this)[0].feature.properties;
    $("#main").load('bronnen/woningkaarten/adres.php?adressen=' + JSON.stringify(props['adressen']));
